...
int orph_ctest_omp_task_if(FILE * logFile){
...
#pragma omp task  shared(count, result)
        {
...
int main()
{
	...
	static const char * logFileName = "bin/c/orph_ctest_omp_task_if.log";	/* name of the logfile */
	...
	for ( i = 0; i < REPETITIONS; i++ ) {
		fprintf (logFile, "\n\n%d. run of orph_ctest_omp_task_if out of %d\n\n",i+1,REPETITIONS);
		if(orph_ctest_omp_task_if(logFile)){
