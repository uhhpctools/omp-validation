...
int ctest_omp_parallel_reduction(FILE * logFile){
	int sum=0;
	int known_sum;
	double dsum=0;
	double dknown_sum;
...
int main()
{
	...
	static const char * logFileName = "bin/c/ctest_omp_parallel_reduction.log";	/* name of the logfile */
	...
	printf("##############################################\n");
	printf("Testing omp parallel reduction\n\n");

	fprintf(logFile,"######## OpenMP Validation Suite V %s ######\n", OMPTS_VERSION );
	fprintf(logFile,"## Repetitions: %3d                       ####\n",REPETITIONS);
	fprintf(logFile,"## Loop Count : %6d                    ####\n",LOOPCOUNT);
	fprintf(logFile,"##############################################\n");
	fprintf(logFile,"Testing omp parallel reduction\n\n");

	for ( i = 0; i < REPETITIONS; i++ ) {
		fprintf (logFile, "\n\n%d. run of ctest_omp_parallel_reduction out of %d\n\n",i+1,REPETITIONS);
		if(ctest_omp_parallel_reduction(logFile)){
