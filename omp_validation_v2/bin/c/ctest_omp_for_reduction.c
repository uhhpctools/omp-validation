...
int ctest_omp_for_reduction (FILE * logFile)
{
...
int main()
{
	...
	static const char * logFileName = "bin/c/ctest_omp_for_reduction.log";	/* name of the logfile */
	...
	for ( i = 0; i < REPETITIONS; i++ ) {
		fprintf (logFile, "\n\n%d. run of ctest_omp_for_reduction out of %d\n\n",i+1,REPETITIONS);
		if(ctest_omp_for_reduction(logFile)){
