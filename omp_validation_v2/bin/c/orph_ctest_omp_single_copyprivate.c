...
int orph_ctest_omp_single_copyprivate(FILE * logFile)                                   
{
...
int main()
{
	...
	static const char * logFileName = "bin/c/orph_ctest_omp_single_copyprivate.log";	/* name of the logfile */
	...
	for ( i = 0; i < REPETITIONS; i++ ) {
		fprintf (logFile, "\n\n%d. run of orph_ctest_omp_single_copyprivate out of %d\n\n",i+1,REPETITIONS);
		if(orph_ctest_omp_single_copyprivate(logFile)){
