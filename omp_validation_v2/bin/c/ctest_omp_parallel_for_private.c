...
int ctest_omp_parallel_for_private(FILE * logFile){
    int sum = 0;
    int known_sum;
    int i, i2;
...
int main()
{
	...
	static const char * logFileName = "bin/c/ctest_omp_parallel_for_private.log";	/* name of the logfile */
	...
	for ( i = 0; i < REPETITIONS; i++ ) {
		fprintf (logFile, "\n\n%d. run of ctest_omp_parallel_for_private out of %d\n\n",i+1,REPETITIONS);
		if(ctest_omp_parallel_for_private(logFile)){
