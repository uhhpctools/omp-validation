...
int orph_ctest_omp_parallel_private(FILE * logFile)
{
...
int main()
{
	...
	static const char * logFileName = "bin/c/orph_ctest_omp_parallel_private.log";	/* name of the logfile */
	...
	for ( i = 0; i < REPETITIONS; i++ ) {
		fprintf (logFile, "\n\n%d. run of orph_ctest_omp_parallel_private out of %d\n\n",i+1,REPETITIONS);
		if(orph_ctest_omp_parallel_private(logFile)){
